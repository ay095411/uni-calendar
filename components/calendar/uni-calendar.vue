<template>
	<div class="uni-calendar" ref="calendar">
		...
		<div class="uni-calendar-change" :class="{'show': yearsShow}">
...
<script>
	import calendar from '@/common/calendar/calendarinit.js';
	import '@/common/calendar/icon.css';
	import '@/common/calendar/style.css';
		...
		methods: {
			...
			select(k1, k2, data, e) {
				...
				if (this.range) {
					...
					this.day = day;
					const selectDay = this.zero ? [this.year, this.zeroPad(this.month + 1), this.zeroPad(day)] : [this.year, this.month +
						1, day
					];
